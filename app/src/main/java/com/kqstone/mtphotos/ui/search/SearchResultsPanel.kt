...
fun SearchResultsPanel(
    ...
    val stateKey = "$searchType:$resultCount:${searchError.orEmpty()}"
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = when {
                    isSearching && resultCount == 0 -> "正在搜索"
                    resultCount > 0 -> "$resultCount 项"
                    else -> ""
                },
            ...
            searchError != null && resultCount == 0 -> {
                Box(
                    ...
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                        Text(text = searchError, color = MaterialTheme.colorScheme.onSurfaceVariant)
